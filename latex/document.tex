...
\begin{figure}[htb]
	\caption{\label{cm-fine-tunning} Matrix de confusão - Fine Tunning }
	\begin{center}
		\includegraphics[scale=0.5]{images/cm_fine_tunning.png}
	\end{center}
	\legend{Fonte: O Autor}
\end{figure}

\begin{figure}[htb]
	\caption{\label{cm-from-scratch} Matrix de confusão - From Scratch Model }
	\begin{center}
		\includegraphics[scale=0.5]{images/cm_from_scratch.png}
	\end{center}
	\legend{Fonte: O Autor}
\end{figure}
